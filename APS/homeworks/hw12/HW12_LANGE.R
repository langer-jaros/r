# Vypracovani 12. domaciho ukolu #
# Jaroslav Langer, 2020/05/17 #
...
# home_office.txt
data <- read.table(paste(KOREN, DATA, "home_office.txt", sep="\\"), header = T)
data # vypis
data<-as.matrix(data)
data # vypis
...
# hruba_mzda.txt
data <- read.table(paste(KOREN, DATA, "hruba_mzda.txt", sep="\\"), header = F)
data # vypis
data<-as.matrix(data)
data # vypis
...
data <- read.table(paste(KOREN, DATA, "iq.txt", sep="\\"), header = F)
data # vypis
data<-as.matrix(data)
data # vypis
...
data <- read.table(paste(KOREN, DATA, "vysledky_iq.txt", sep="\\"), header = F)
data # vypis
data<-as.matrix(data)
data # vypis
