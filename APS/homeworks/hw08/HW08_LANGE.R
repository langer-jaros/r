...
hist(zadani$iq)
# Zda se ze celkove IQ muze pochazet z normalniho rozdeleni #
####################### KVŮLI ZMĚNÁM (VIZ KOMENTÁŘ NÍE) SE TA NORMALITA MŮE JETĚ VÍCE POKAZIT. KDYBY SE OTESTOVALA, TAK BY SE NA PĚTI
####################### PROCENTECH ZAMÍTALA :-P.

boxplot(zadani$iq)
qqnorm(zadani$iq)
# V souboru jsou dve odlehla pozorovani, konkretne zmeny 145->155 a 139->150 od minule #
####################### TO JSTE PRVNÍ, KDO SI TOHO VIML :-D.

####################### PŘÍTĚ U PROSÍME I TY ČÍSELNÉ HODNOTY (ANEBO PŘEDEVÍM), NEJEN PŘÍKAZY, JINAK BYCHOM VÁM TO MUSELI VRÁTIT. TEĎ SE
####################### TO TÝKÁ PŘÍKLADU 3
...
median(zadani$iq)
####################### TO BYSTE NEMUSEL DÁVAT PŘEDNOST ANI JEDNÉ CHARAKTERISTICE, NEBO V PŘÍPADĚ NORMÁLNÍHO ROZDĚLENÍ JE STŘEDNÍ HODNOTA
####################### ROVNA MEDIÁNU :-D. A V NAEM PŘÍPADĚ TOMU TAK SKORO JE. 
...
####################### TU JSTE MOHL POUÍT TÉ PŘÍKAZ Z KNIHOVNY TeachingDemos

### 4. Nasledujici otazky nesouvisi s R-kem, ale je dobre si to promyslet. #
#      Odpovezte na nasledujici otazky ANO/NE/NELZE RICI: ###

###   (a) Jestlize stredni hodnota ľ lezi uvnitr 95% intervalu spolehlivosti, lezi i v 90% intervalu? ###
NELZE RICI
###   (b) Jestlize lezi stredni hodnota ľ v 90% intervalu spolehlivosti, lezi i v 95% intervalu? ###
ANO
###   (c) Jestlize stredni hodnota ľ nelezi v 95% intervalu spolehlivosti, muze lezet v 90% intervalu spolehlivosti? ###
NE
###   (d) Jestlize stredni hodnota ľ nelezi v 95% intervalu spolehlivosti, muze lezet v 99% intervalu spolehlivosti? ###
ANO
